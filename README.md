...
# Workout Tracker
<img src="img/dash.jpg" width="650" height="100" />
...
## Github Deployed
 https://kwakuasare.github.io/weatherapp/
...
## Description:
The Weather-app allows users to get the current weather conditions and also a 4-Day weather forecast at their current location. Users can also utilise the search box and search for any location and get the weather of that location.
...
## Usage Information:
Users do not need to create an account.Users will be prompted to "allow location" services to be used. Users need to allow it for the app to give them the weather conditions in their location. Users can also search for any location by name using the search box.
...
## Repositories
- [Github Deployed Link](https://kwakuasare.github.io/weatherapp/)
- [GitHub Repository](https://github.com/KwakuAsare/weatherapp)
